...
wget github.com/Edsombj/PAINEL-WEB/blob/main/psshplus--main/gestorssh/sshplus.zip.001 > /dev/null 2>&1
wget github.com/Edsombj/PAINEL-WEB/blob/main/psshplus--main/gestorssh/sshplus.zip.002 > /dev/null 2>&1
wget github.com/Edsombj/PAINEL-WEB/blob/main/psshplus--main/gestorssh/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget github.com/Edsombj/PAINEL-WEB/blob/main/psshplus--main/gestorssh/sincpainel.zip > /dev/null 2>&1
