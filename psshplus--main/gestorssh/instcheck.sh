...
sleep 5
cd /bin || exit
wget https://github.com/Edsombj/PAINEL-WEB/blob/main/psshplus--main/gestorssh/chuser > /dev/null 2>&1
wget https://github.com/Edsombj/PAINEL-WEB/blob/main/psshplus--main/gestorssh/userscheck > /dev/null 2>&1
...
wget https://github.com/Edsombj/PAINEL-WEB/blob/main/psshplus--main/gestorssh/checkuser.py > /dev/null 2>&1
